...
export default function HeroSection() {
  ...
  return <div ref={homeRef} className="h-[100dvh] relative flex w-full flex-col items-center justify-center">
    <span className="md:text-left flex flex-col items-center gap-2 z-30 ">
      ...
      <h2 className="text-xs lg:text-sm rounded-full mt-2 p-2 border-2 border-brown-white text-center">I build dynamic web <span className="text-orange-300">applications</span> from concept to <span className="text-cyan-400">deployment</span></h2>
