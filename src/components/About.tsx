export default function About() {
  return <div className="flex flex-col gap-4 md:gap-10 text-white  py-16">
    <div className="text-left md:w-[55%]">
      <h2 className="md:text-3xl">I'm a <span className="text-purple-500">Software Engineering</span> Student,</h2>
      <h2 className="text-xl md:text-4xl">Specialising in develop and deploying <span className="text-orange-300">scalable web applications</span>.</h2>
    </div>
